...
try {
    ...
    document.getElementById('open-room').onclick = function() {
        ...
        $("#open-room").attr("disabled","");
        $("#pausevideo").removeAttr("disabled");
...
document.getElementById('join-room').onclick = function() {
    ...
    // connection.join(document.getElementById('roomnum').value);
    // connection.join('123');
};
...
connection.socketURL = 'https://192.168.0.38:9001/';
...
connection.onstream = function(event) {
    ...
    $("#pausevideo").click(function(){
        ...
        websocket.send('[방송정지]' + ":" + "dw");

        document.getElementById('open-room').disabled = false;

        $("#pausevideo").attr("disabled","");
        $("#restartvideo").removeAttr("disabled");

        // $(".media-container").attr("style","display : none;");
        // $("#pausevideo").attr("disabled",'');
    ...
    $("#restartvideo").click(function(){
        ...
        // video.srcObject.getAudioTracks().forEach((track) => (track.start()));
        // $("#videos-container").html("");
        // $("#videos-container").removeAttr("style");
        ...
        $("#pausevideo").removeAttr("disabled");
        $("#restartvideo").attr("disabled","");

        websocket.send('[방송재개]:' + "dw");
